    ...
    validate: [
        {
          validator: function (email) {
            ...
            console.log(`Email validation: ${email} is ${isValid ? 'valid' : 'invalid'}`);
            return isValid;
          },
          message: (props) => `Provided email (${props.value}) is invalid`,
        },
        {
          validator: function (email) {
            ...
            console.log(`Email check: ${email} is ${isDisposable ? 'disposable' : 'not disposable'}`);
            return !isDisposable;
          },
        ...
        },
        {
          validator: function (email) {
            ...
            console.log(`Email check: ${email} username is ${isRestricted ? 'restricted' : 'allowed'}`);
            return !isRestricted;
          },
...
userSchema.pre('save', async function(next) {
    if (this.isModified('password') && this.password) {
      ...
      console.log('Password expiry date set to:', this.passwordExpiry);
